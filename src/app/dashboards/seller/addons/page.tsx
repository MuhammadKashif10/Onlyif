...
export default function AddonsPage() {
  ...
  const addons: Addon[] = [
    {
      ...
      description: 'High-quality professional photography that showcases your property in the best possible light.',
      price: 99.99,
    ...
    },
    {
      id: 'floorplan',
      title: 'Floorplan',
      description: 'Professional floor plan creation to help buyers visualize the property layout and flow.',
      price: 149.99,
    ...
    },
    {
      id: 'drone-footage',
      title: 'Drone Footage',
      description: 'Stunning aerial photography and video footage to showcase your property and surrounding area.',
      price: 199.99,
    ...
    },
    {
      ...
      description: 'Professional or DIY guided video tour that lets buyers explore your property virtually.',
      price: 79.99,
  ...
  const markAddonsAsActive = async (addonIds: string[]) => {
    // Simulate API call to mark add-ons as active
    try {
      const response = await fetch('/api/mark-addons-active', {
        method: 'POST',
  ...
  const handlePaymentSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // In production, you would use Stripe Elements for secure card input
      await new Promise(resolve => setTimeout(resolve, 2000));
      
      // Mark add-ons as active
